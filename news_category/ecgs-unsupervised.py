...
for l in range(L):
    ...
    print(l, '-th loop, ', 'Time of d-loop: ', stop_loop1 - start_loop1)
    ...
    print(l, '-th loop, ', 'Time of d1-loop: ', stop_loop2 - start_loop2)
    ...
    print(l, '-th loop, ', 'Time of k1-loop: ', stop_loop3 - start_loop3)
