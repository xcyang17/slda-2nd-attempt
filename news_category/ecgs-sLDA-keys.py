...
i_txt = open(working_dir + "i-3.txt", "r")
...
j_txt = open(working_dir + "j-3.txt", "r")
...
v_txt = open(working_dir + "v-3.txt", "r")
...
terms_txt = open(working_dir + "Terms-3.txt", "r")
...
docs_txt = open(working_dir + "Docs-3.txt", "r")
