...
unique.terms = (news_id_dtm2$dimnames$Terms)
sigularized.terms = singularize(unique.terms)
save(file = "unique-terms-news_id_dtm2.Rdata", unique.terms)
save(file = "singularized-unique-terms-news_id_dtm2.Rdata", sigularized.terms)

head(unique.terms[unique.terms != sigularized.terms], 10)
head(sigularized.terms[unique.terms != sigularized.terms], 10)
