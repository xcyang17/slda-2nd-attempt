...
print('Time: ', stop - start) # 2.775008938 seconds
...
print('Time: ', stop_1 - start_1) # 1641.6729263749999

# store the files
save_dir = "/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/unsupervised-4-topics/"
#np.save(save_dir+"theta-unsupervised-crime-education-sports-religion.npy", theta_sample)
#np.save(save_dir+"phi-unsupervised-crime-education-sports-religion.npy", phi_sample)

# save the estimates from last 10 iterations
theta_sample = np.load(save_dir + "theta-unsupervised-crime-education-sports-religion.npy")
phi_sample = np.load(save_dir + "phi-unsupervised-crime-education-sports-religion.npy")

np.save(save_dir+"theta-4-topics-last-10-iters.npy", theta_sample[:,:,489:499])
np.save(save_dir+"phi-4-topics-last-10-iters.npy", phi_sample[:,:,489:499])
