...
print('Time: ', stop - start) # 2.633756852000001 seconds
...
print('Time: ', stop_1 - start_1) # 3586.843102335


save_dir = "/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/cgs-unsupervised-5-topics/"
np.save(save_dir+"theta-cgs-5-topics.npy", theta_sample)
np.save(save_dir+"phi-cgs-5-topics.npy", phi_sample)
