...
# -*- coding: utf-8 -*-
"""
Created on Wed May 22 16:10:04 2019
...
print('Time: ', stop_1 - start_1) # 2327.083145693 seconds

# save dictionaries and y
np.save('/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/2nd-attempt/l2_loss_5_topic/obj/doc_term_prob_dict.npy', doc_term_prob_dict)
np.save('/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/2nd-attempt/l2_loss_5_topic/obj/doc_doc_term_dict.npy', doc_doc_term_dict)
np.save('/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/2nd-attempt/l2_loss_5_topic/obj/doc_term_dict_R31.npy', doc_term_dict_R31)
np.save('/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/2nd-attempt/l2_loss_5_topic/obj/y.npy', y)
...
doc_term_prob_dict = np.load('/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/2nd-attempt/l2_loss_5_topic/obj/doc_term_prob_dict.npy').item()
doc_doc_term_dict = np.load('/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/2nd-attempt/l2_loss_5_topic/obj/doc_doc_term_dict.npy').item()
doc_term_dict_R31 = np.load('/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/2nd-attempt/l2_loss_5_topic/obj/doc_term_dict_R31.npy').item()
y = np.load('/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/2nd-attempt/l2_loss_5_topic/obj/y.npy')
...
np.save('/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/2nd-attempt/l2_loss_5_topic/obj/topic_mapping_dict.npy', topic_mapping_dict)
...
for i in range(num_init_vals):
    ...
    for k in range(n_folds):
        ...
        f_cg = open("/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/2nd-attempt/l2_loss_5_topic/initial_val_search_output/seed" + 
...
np.max(cv_scores) # 0.4811216908204399
np.argmax(cv_scores) # 14
test_pred_accuracy[np.argmax(cv_scores)] # 0.47738693467336685
