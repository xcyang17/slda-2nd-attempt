...
print('Time: ', stop - start) # 1.2516203840000344 seconds
...
print('Time: ', stop_1 - start_1) # 1123.500180554



# store the files
save_dir = "/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/cgs-2-topics/"
np.save(save_dir+"theta-unsupervised-cgs-2-topics.npy", theta_sample)
np.save(save_dir+"phi-unsupervised-cgs-2-topics.npy", phi_sample)
...
np.save(save_dir+"theta-cgs-2-topics-last-10-iters.npy", theta_sample[:,:,489:499])
np.save(save_dir+"phi-cgs-2-topics-last-10-iters.npy", phi_sample[:,:,489:499])
