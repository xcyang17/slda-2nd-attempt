...
print('Time: ', stop - start) # 1.5130115400000008 seconds
...
print('Time: ', stop_1 - start_1) # 1778.271082098


save_dir = "/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/cgs-unsupervised-3-topics/"
np.save(save_dir+"theta-cgs-3-topics.npy", theta_sample)
np.save(save_dir+"phi-cgs-3-topics.npy", phi_sample)
