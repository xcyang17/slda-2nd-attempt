...
print('Time: ', stop - start) # 2.2871786830000005 seconds
...
print('Time: ', stop_1 - start_1) # 1104.957848438


# store the files
save_dir = "/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/ecgs-3-topics/"
np.save(save_dir+"theta-unsupervised-ecgs-3-topics.npy", theta_sample)
np.save(save_dir+"phi-unsupervised-ecgs-3-topics.npy", phi_sample)
...
np.save(save_dir+"theta-ecgs-3-topics-last-10-iters.npy", theta_sample[:,:,489:499])
np.save(save_dir+"phi-ecgs-3-topics-last-10-iters.npy", phi_sample[:,:,489:499])
