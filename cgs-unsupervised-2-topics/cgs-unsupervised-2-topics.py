...
print('Time: ', stop - start) # 0.8424484139999997 seconds
...
print('Time: ', stop_1 - start_1) # 991.2720194890001


save_dir = "/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/cgs-unsupervised-2-topics/"
np.save(save_dir+"theta-cgs-2-topics.npy", theta_sample)
np.save(save_dir+"phi-cgs-2-topics.npy", phi_sample)


prob_true_label = 0.8 # subject to change
prob_vect = np.full(K, (1-prob_true_label)/(K-1))
prob_vect[true_label] = prob_true_label
