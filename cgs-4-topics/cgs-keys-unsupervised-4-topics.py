...
print('Time: ', stop - start) # 2.2865138309999997 seconds
...
print('Time: ', stop_1 - start_1) # 2501.3613545370004



# store the files
save_dir = "/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/cgs-4-topics/"
np.save(save_dir+"theta-unsupervised-cgs-4-topics.npy", theta_sample)
np.save(save_dir+"phi-unsupervised-cgs-4-topics.npy", phi_sample)
...
np.save(save_dir+"theta-cgs-4-topics-last-10-iters.npy", theta_sample[:,:,489:499])
np.save(save_dir+"phi-cgs-4-topics-last-10-iters.npy", phi_sample[:,:,489:499])
