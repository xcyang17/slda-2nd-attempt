...
print('Time: ', stop - start) # 2.5206870080000003 seconds
...
print('Time: ', stop_1 - start_1) # 3499.217679814



# store the files
save_dir = "/Files/documents/ncsu/fa18/ST740/ST740-FA18-Final/cgs-5-topics/"
np.save(save_dir+"theta-unsupervised-cgs-5-topics.npy", theta_sample)
np.save(save_dir+"phi-unsupervised-cgs-5-topics.npy", phi_sample)
...
np.save(save_dir+"theta-cgs-5-topics-last-10-iters.npy", theta_sample[:,:,489:499])
np.save(save_dir+"phi-cgs-5-topics-last-10-iters.npy", phi_sample[:,:,489:499])
